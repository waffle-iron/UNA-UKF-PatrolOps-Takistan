...
[
	...
	[
		...
		[
			"%1 <br/><br/>
			<font face='PuristaBold'><font size=18>[RIP] Operations</font></font> 
			<br/><br/>%1 
			<br/><br/>
			Dynamic Mission Sandbox
			<br/><br/>%1 
			<br/><br/>
			Introduction:
			<br/><br/>
			Infantry troops will spawn at the <font face='PuristaBold'><marker name='respawn_east'>Infantry Base</marker></font>
			<br/><br/>
			Pilots will spawn at the <font face='PuristaBold'><marker name='respawn_guerrila'>AirBase</marker></font>  
			<br/><br/>
			Missions are randomly and dynamically generated once the mission has begun.  
			<br/>
			<br/><br/>%1 
			<br/>",
			_div
...
[
	...
	[
		...
		[
			"%1 <br/><br/>
			<font face='PuristaBold'><font size=18>Command</font></font>
			<br/>
			The command section is in charge of the overall strategy for missions and will command all subsequent sections.
			<br/><br/>%1
			<br/>			
			<font face='PuristaBold'><font size=18>Alpha</font></font>
			<br/>
			Alpha Section is an Infantry section. They have access to wheeled vehicles.
			<br/><br/>%1 
			<br/>	
			
			<font face='PuristaBold'><font size=18>Bravo</font></font>
			<br/>
			Alpha Section is an Infantry section. They have access to wheeled vehicles.
			<br/><br/>%1 
			<br/>	
			
			<font face='PuristaBold'><font size=18>Charlie</font></font>
			<br/>
			Charlie is the crew section and the only players who have access to tracked and heavy vehicles.
			<br/><br/>%1 
			<br/>	
			
			<font face='PuristaBold'><font size=18>Delta</font></font>
			<br/>
			Delta is the pilot section and the only players who have access to air units.
			<br/>
...
player createDiaryRecord ["PO3WB",["Version",format["MultiPlayer Scripting Framework<br/>Version %1",localize "STR_PO3_VERSION"]]];

player createDiaryRecord ["PO3WB",["Tasks","
...
player createDiaryRecord ["PO3WB",["Redeployment","
...
/*
player createDiaryRecord ["PO3WB",["NCWS","
Info about the Network Centric Warefare System
"]];
player createDiaryRecord ["PO3WB",["Medical","
Medical System<br/>
<br/>
...
"]];
*/
player createDiaryRecord ["PO3WB",["Logistics","
...
player createDiaryRecord ["PO3WB",["IEDs","
IED System<br/>
<br/>
...
player createDiaryRecord ["PO3WB",["HUD","The Player Hud<br/><br/>The hud allows you to set your view distance options, terrain detail and density and toggle the 3D names that appear above each of nearby players.<br/>These options can be disabled by the mission admin."]];