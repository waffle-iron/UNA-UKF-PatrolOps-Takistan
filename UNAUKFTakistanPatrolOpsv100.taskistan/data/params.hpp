...
//	};
//	class COS_ambientCivs {
//		title = "Ambient Civillians";
//		values[]={0,1};
//		texts[]={$STR_PO3_TEXT_OFF,$STR_PO3_TEXT_ON};
//		default=0;
//		code = "COS_ambientCivs_enable = if(%1 > 0)then{true}else{false};";
//	};
//	class PO3_param_ambientCivTraffic {
//		title = "Ambient Traffic";
//		values[]={0,1};
//		texts[]={$STR_PO3_TEXT_OFF,$STR_PO3_TEXT_ON};
//		default=0;
//		code = "PO3_param_ambient_civtraffic_enable = if(%1 > 0)then{true}else{false};";
//	};
