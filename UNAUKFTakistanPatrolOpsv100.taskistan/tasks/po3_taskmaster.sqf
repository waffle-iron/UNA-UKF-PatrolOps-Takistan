...
//	,"PO3_task_m03_attackConvoySupply"	// <!-- TEST		COMMENTED OUT BY DEFAULT
//	,"PO3_task_m04_captureIntel"		// <!-- TEST		COMMENTED OUT BY DEFAULT
...
//	,"PO3_task_m09_clearRunway"			// <!-- TEST		COMMENTED OUT BY DEFAULT
//	,"PO3_task_m10_clearSeaMinefield"	// <!-- TEST		COMMENTED OUT BY DEFAULT
	,"PO3_task_m11_createSupplies"		// <!-- TEST
	,"PO3_task_m12_createTower"			// <!-- TEST
//	,"PO3_task_m13_defendBase"			// <!-- TEST		NOT BEING USED FOR RIP
//	,"PO3_task_m14_defendDamagedBoat"	// <!-- TEST		COMMENTED OUT BY DEFAULT
//	,"PO3_task_m15_defendTown"			// <!-- TEST		NOT BEING USED FOR RIP
...
//	,"PO3_task_m20_rescuePilots"		// <!-- TEST		COMMENTED OUT BY DEFAULT
	,"PO3_task_m21_captureCity"			// <!-- TEST		MY OWN MISSION
];
