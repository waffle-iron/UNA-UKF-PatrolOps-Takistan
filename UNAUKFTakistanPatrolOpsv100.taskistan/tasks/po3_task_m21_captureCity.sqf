...
// =========================================================================================================
_location = "city" call PO3_fnc_getNewPos;
...
[ format["TASK%1",PO3_TASK__IDD],
	format[localize "STR_PO3_M21_TITLE",_locaname],
	format[localize "STR_PO3_M21_DESCR",PO3_TASK__IDD,_locaname],
	(PO3_side_1 select 0),
	[format["MRKR%1",PO3_TASK__IDD],PO3_TASK__POS,"mil_objective",(PO3_side_3 select 0) call PO3_fnc_getUnitMarkerColour,format[localize "STR_PO3_M21_TITLE",_locaname]],
	"assigned",
	(PO3_TASK__POS),
	format[localize "STR_PO3_M21_TITLE",_locaname]
] call PO3_fnc_addTask;

["TASK",format["Generated ID:%1 Type:%2 Location:%3 EN:%4 Veh:%5",PO3_TASK__IDD,"CaptureCity",_location,count PO3_TOTAL_UNITS,count PO3_TOTAL_VEHICLES],true] spawn PO3_fnc_log;
